type VoteDownIconProps = {
  color?: string
}

function VoteDownIcon({ color }: VoteDownIconProps) {
  return (
    <svg fill={color || '#999999'} width="24px" height="24px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
